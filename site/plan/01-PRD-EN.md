...
| Status | Approved baseline; implementation plan derived (`02-Production-Plan`); Phase 0 in progress (2026-06) — Agent Core §1.1 + Memory Subsystem §1.2–1.4 + HR memory governance §1.5 + injection-defence/pre-compression §1.6 built (§1.1–§1.5 merged to `main`; §1.6 complete, in merge) |
